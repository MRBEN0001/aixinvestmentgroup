	...
	<div class="newsletter-sec" style="display:none">
		<div class="container"> 
			...
			<div class="news-message">
				...
				[newsletter_form confirmation_url="https://www.aixinvestment.com/" ]			</div>
		</div>
		<div class="footer-content clearfix">
			<div class="container">
				...
				<div class="footer-col-1">
					<a href="{{ url('/') }}" class="logo" ><img src="asset/wp-content/themes/twentytwenty-child/assets/images/logo.png" alt="We help companies become strong and grow"></a>
				</div>
...
<div class="footer-col-3">
	<div class="footer-nav desktop-footer">
		...
		{{-- <div class="menu-footer-menu-container"><ul id="menu-footer-menu" class="menu"><li id="menu-item-596" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-home current-menu-item page_item page-item-56 current_page_item menu-item-596"><a href="index.html" aria-current="page">Home</a></li> --}}
{{-- <li id="menu-item-653" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-653"><a href="{{ route('contact-us') }}">Contact Us</a></li> --}}
{{-- <li id="menu-item-660" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-privacy-policy menu-item-660"><a href="privacy-policy/index.html">Privacy Policy</a></li> --}}
{{-- <li id="menu-item-656" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-656"><a href="terms-and-conditions/index.html">Terms and Conditions</a></li> --}}
{{-- <li id="menu-item-601" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-601"><a href="insights/index.html">Insights</a></li> --}}
{{-- <li id="menu-item-658" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-658"><a href="disclaimer/index.html">Disclaimer</a></li> --}}
{{-- <li id="menu-item-602" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-602"><a href="careers/index.html">Careers</a></li> --}}
</ul></div>
	</div>
...
{{-- <li id="menu-item-905" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-privacy-policy menu-item-905"><a href="privacy-policy/index.html">Privacy Policy</a></li> --}}
{{-- <li id="menu-item-907" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-907"><a href="terms-and-conditions/index.html">Terms and Conditions</a></li> --}}
{{-- <li id="menu-item-910" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-910"><a href="disclaimer/index.html">Disclaimer</a></li> --}}
</ul></div>
	</div>
	<div class="clr"></div>
...
<br />
		...
		<div class="right">
					...
					<img src="asset/wp-content/uploads/2020/02/footerlogo-1.jpg" alt="">

				
					<img src="asset/wp-content/uploads/2020/02/footerlogo-2.jpg" alt="">
...
<!-- ÃËœÃÂ½ÃÂ²ÃÂµÃ‘ÂÃ‘â€šÃÂ¸Ã‘â€ ÃÂ¸ÃÂ¾ÃÂ½ÃÂ½ÃÂ¾ÃÂ¹ ÃÂ³Ã‘â‚¬Ã‘Æ’ÃÂ¿ÃÂ¿Ã‘â€¹ AIX -->
</div>
