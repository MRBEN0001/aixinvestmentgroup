...
<head>
    ...
    <title>{{ $teslaProduct->title }} | AIX Investment Group</title>
    <style>
        :root {
            --aix-black: #070707;
            --aix-dark: #141414;
...
<body>
    <header class="property-header">
        ...
        <nav>
            <a href="{{ route('tesla') }}">Tesla Products</a>
        ...
        <div class="property-wrap">
            <section class="property-gallery" data-property-gallery>
                @if (! empty($teslaProduct->product_images))
                    <img class="property-main-image" src="{{ $teslaProduct->product_images[0] }}" alt="{{ $teslaProduct->title }}" data-property-main-image>
            ...
            <section>
                <span class="eyebrow">Tesla Product Details</span>
                <h1>{{ $teslaProduct->title }}</h1>
                <p class="property-description">{{ $teslaProduct->description }}</p>
                ...
                <div class="property-actions">
                    ...
                    <a class="property-action secondary" href="{{ route('tesla') }}">View More Products</a>
                </div>

                @if (! empty($teslaProduct->feature_list))
                    <div class="features">
                        <h2>Product Features</h2>
                        <ul>
                            @foreach ($teslaProduct->feature_list as $feature)
                                <li>{{ $feature }}</li>
                            @endforeach
                        </ul>
                    </div>
