...
<body>
    ...
    <main class="payment-section">
        <div class="payment-wrap">
            <span class="eyebrow">Tesla Payment</span>
            <h1>Complete Your Tesla Product Investment</h1>
            <p class="lead">Pay the exact product amount shown below to one of the wallet addresses. After payment, chat support with your payment screenshot so they can proceed with your investment.</p>

            <section class="property-summary">
                @if ($teslaProduct->image_url)
                    <img src="{{ $teslaProduct->image_url }}" alt="{{ $teslaProduct->title }}">
                @else
                ...
                <div>
                    ...
                    <span class="property-amount">${{ number_format($teslaProduct->price, 2) }}</span>
                </div>
            </section>
            ...
            <div class="support-note">
                <strong>Important:</strong> Pay the exact amount of ${{ number_format($teslaProduct->price, 2) }}, then open live chat support and send your screenshot so the support team can verify the payment and proceed with your investment.
            </div>
        </div>
    </main>
