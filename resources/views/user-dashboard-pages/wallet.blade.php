                            ...
                            <div class="custom-block custom-block-transations">
                                ...
                                <div class="d-flex flex-wrap align-items-center mb-4">
                                    <div class="d-flex align-items-center">
                                        <img src="{{ asset('dash/images/profile/senior-man-white-sweater-eyeglasses.jpg') }}" class="profile-image img-fluid" alt="">
                                ...
                                <div class="d-flex flex-wrap align-items-center mb-4">
                                    <div class="d-flex align-items-center">
                                        <img src="{{ asset('dash/images/profile/young-beautiful-woman-pink-warm-sweater.jpg') }}" class="profile-image img-fluid" alt="">
                                ...
                                <div class="d-flex flex-wrap align-items-center">
                                    <div class="d-flex align-items-center">
                                        <img src="{{ asset('dash/images/profile/young-woman-with-round-glasses-yellow-sweater.jpg') }}" class="profile-image img-fluid" alt="">
